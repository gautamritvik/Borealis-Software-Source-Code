...
# Manifesto
To read Borealis Modern Free Open-Source Software (MFOSS) Project Manifesto, click [here](https://github.com/gautamritvik/Borealis-Software-Source-Code/blob/main/BOREALIS_MFOSS_MANIFESTO.md) (its pretty long!)
# Software that is in the Borealis Project
- Curl, an open-source programming language made on Python technology that integrates AI. ([GitHub page](https://github.com/gautamritvik/Curl-Programming))
- Textitor, an open-source AI-integrated word processor, pronounced as "Tex - ti - tor". ([GitHub page](https://github.com/gautamritvik/Textitor))
